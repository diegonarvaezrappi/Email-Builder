...
export const bannerItemRegistry: Record<BannerItemType, BannerItemDef<any>> = {
  ...
  // [[project_body_modules_plan_2026-08-26]]) — zone MOLECULA, ninguna
  // depende de la orientación del banner (mismo archivo/comportamiento en
  // horizontal y vertical, a diferencia de PROMO/TEXTOXL/etc.).
  SEPARADOR: {
    type: 'SEPARADOR',
    label: 'Separador',
    zone: 'MOLECULA',
  ...
  FRANJA_LOGOS: {
    ...
    Icon: MOLECULE_ICONS.FRANJA_LOGOS,
  },
  TEXTO_PASTILLA: {
    type: 'TEXTO_PASTILLA',
    ...
    Icon: MOLECULE_ICONS.TEXTO_PASTILLA,
  },
}
